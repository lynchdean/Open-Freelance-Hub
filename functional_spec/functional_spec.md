...
* [3. Functional Requirements](#3-funtional-requirements)
    * [3.1 New Users](#31-new-users)
    * [3.2 Posting a Job](#32-posting-a-job)
    * [3.3 Applying to a Job](#33-applying-to-a-job)
    * [3.4 Browsing All Open Jobs/Available Candidates](#34-browsing-all-open-jobsavailable-candidates)
    * [3.5 Employer Accepts Candidate](#35-employer-accepts-candidate)
    * [3.6 Trading Work Instead of Currency](#36-trading-work-instead-of-currency)
    * [3.7 Contact Between Users](#37-contact-between-users)
